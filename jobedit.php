    ...
    <div class="col-12 col-md-12">
        <div class="card">
            <h5 class="card-header">Employee Register</h5>
             ...
             <?php 
                    $ujobid=$_GET['jobid'];
                    $sql = "SELECT *from job where jobid='$ujobid'";
        ...
        if(isset($_POST['btn']))
            {
                ...
                $sql="UPDATE job SET jobid='$jobid',customername='$customername',jobdesc='$jobdesc',startdate='$startdate', enddate='$enddate' WHERE jobid='$ujobid'";
